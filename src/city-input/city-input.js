...
render(){
    return(
        <div className="input">
           <input type="text" className="form-control" id="search" placeholder="Search for..." onChange={this.onCityNameChange} />
        <span className="input-btn">
            <button className="button" id="btn"onClick={this.onBtnClick} >
